...
train_df = pd.read_csv('F:/project/project/dilsha/demoproject/input/train.csv')
test_df = pd.read_csv('F:/project/project/dilsha/demoproject/input/test.csv')
...
c=con.cursor()
# print("insert into predict values('"+str(train_df['price'])+"','"+str(train_df['price'].skew())+"','"+str(train_df['price'])+"')"
c.execute("insert into predict values('"+str(train_df['price'])+"','"+str(train_df['price'].skew())+"','"+str(train_df['price'].mean())+"')")
# print("insert into predict values('"+str(train_df['price'])+"','"+str(train_df['price'].skew())+"','"+str(train_df['price'])+"')"
